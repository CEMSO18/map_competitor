...
// Requête SQL pour récupérer toutes les colonnes de la table societe_info_vape_competitor
$sql = "SELECT * FROM societe_info_vape_competitor";
...
<head>
    ...
    <title>Geolocation vape_competitor</title>
...
<body>
    <div class="header">
        ...
        <div class="title">Magasin concurrent en vente de cigarette électronique</div>
    </div>
    ...
    <script>
        ...
        var map = L.map('map').setView([48.897891998291016, 2.0886409282684326], 16);
